...
export default function Dashboard({ user, onLogout }) {
  ...
  if (classroomLoaded && !classroom) {
    return (
      <div style={{ minHeight: '100vh', backgroundImage: 'linear-gradient(rgba(10,13,20,0.82), rgba(10,13,20,0.82)), url(https://bundeswehr-lexikon.de/wp-content/uploads/2017/06/banner.jpg)', backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed', fontFamily: 'Arial', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20 }}>
  ...
  if (hwMode && homework) {
    ...
    return (
      <div style={{ minHeight: '100vh', backgroundImage: 'linear-gradient(rgba(10,13,20,0.82), rgba(10,13,20,0.82)), url(https://bundeswehr-lexikon.de/wp-content/uploads/2017/06/banner.jpg)', backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed', fontFamily: 'Arial', fontSize, color: text }}>
  ...
  if (!pool.length || !cur) {
    ...
    if (refreshing) {
      return (
        <div style={{ minHeight: '100vh', backgroundImage: 'linear-gradient(rgba(10,13,20,0.82), rgba(10,13,20,0.82)), url(https://bundeswehr-lexikon.de/wp-content/uploads/2017/06/banner.jpg)', backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'Arial', color: dim, fontSize }}>
          Laden …
        </div>
      )
    }
    return (
      <div style={{ minHeight: '100vh', backgroundImage: 'linear-gradient(rgba(10,13,20,0.82), rgba(10,13,20,0.82)), url(https://bundeswehr-lexikon.de/wp-content/uploads/2017/06/banner.jpg)', backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 16, fontFamily: 'Arial', fontSize }}>
